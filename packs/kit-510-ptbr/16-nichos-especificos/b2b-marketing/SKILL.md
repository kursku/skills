---
name: b2b-marketing
description: "B2B Marketing — Skill especializada para b2b marketing"
license: MIT
metadata:
  version: 1.0.0
  author: Cafe Code AI
...
```
Sua empresa B2B ainda sofre para gerar leads qualificados e fechar vendas em ciclos longos? 🚀

Muitas organizações B2B perdem oportunidades valiosas por não alinhar suas estratégias de marketing e vendas à jornada complexa do comprador. A verdade é que 70% dos compradores B2B realizam a maior parte da sua pesquisa online antes de falar com um vendedor.

Acabamos de lançar nosso novo "Guia Definitivo: Estratégias de Marketing B2B para Acelerar seu Pipeline", onde detalhamos:
✅ Como construir um ICP que realmente converte.
✅ Técnicas de ABM que geram 3x mais engajamento.
✅ Otimização de funil para reduzir o CAC em 25%.

Este é o roadmap que você precisa para transformar a maneira como sua empresa atrai, nutre e converte clientes B2B.

Baixe agora e dê o próximo passo para um crescimento previsível! 👇
[Link para a Landing Page do Guia]

#B2BMarketing #GeraçãoDeLeads #ABM #VendasB2B #MarketingDigital #GrowthB2B #PipelineDeVendas
```
