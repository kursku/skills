...
description: "Discovery Call Script — Skill especializada para otimizar e padronizar o processo de discovery calls, garantindo qualificações eficazes e alinhamento de expectativas para consultorias."
license: MIT
metadata:
  version: 1.0.0
  author: Cafe Code AI
...
1.  **Definir Agenda Pré-Call**: Enviar um email com os tópicos da discovery call para alinhar expectativas e tempo com o cliente.
2.  **Iniciar com Confirmação**: Abrir a call confirmando a agenda proposta e a duração da conversa (ex: 30-45 minutos).
3.  **Aplicar Perguntas SPIN**: Conduzir a conversa com perguntas de Situação, Problema, Implicação e Necessidade de Solução para mapear dores.
4.  **Validar Entendimento**: Resumir os desafios e impactos discutidos, perguntando ao cliente se a compreensão está correta.
5.  **Propor Próxima Etapa Clara**: Encerrar a call com uma sugestão concreta para o próximo passo (ex: reunião de diagnóstico, proposta de projeto).
...
*   **Passo 1: Preparação Estratégica Pré-Call (15 minutos antes)**
...
*   **Passo 2: Abertura e Alinhamento de Expectativas (5 minutos)**
...
*   **Passo 3: Exploração das Dores com Perguntas SPIN (20-25 minutos)**
...
*   **Passo 4: Resumo, Validação e Priorização (5 minutos)**
...
*   **Passo 5: Proposta de Próxima Etapa Clara (5 minutos)**
...
*   **Passo 1: Reconhecer e Validar a Objeção Imediatamente**
...
*   **Passo 2: Aprofundar a Objeção com Perguntas de Esclarecimento**
...
*   **Passo 3: Recontextualizar o Valor da Solução e o Custo da Inação**
...
*   **Passo 4: Mapear o Processo de Decisão e Decisores Chave**
...
*   **Passo 5: Propor uma Próxima Etapa Reduzida ou Alternativa**
...
1.  **Transformar a discovery em uma apresentação de vendas da consultoria**: O foco da discovery não é falar sobre a solução, mas entender o problema do cliente.
...
2.  **Não mapear a dor real, seu impacto e o senso de urgência**: Ficar na superfície dos problemas sem entender as implicações financeiras ou estratégicas para o cliente.
...
3.  **Não definir uma próxima etapa clara, acordada e com compromisso mútuo**: Terminar a call sem um "call to action" explícito e validado pelo cliente, deixando a oportunidade esfriar.
...
3.  **Mapear o Processo de Decisão e os Decisores Ocultos**: Além do interlocutor, entender quem mais estará envolvido na decisão e quais critérios são importantes para cada um. Isso permite antecipar objeções e preparar o lead para defender a solução internamente.
...
4.  **Pré-qualificação por Email/Formulário Inteligente**: Enviar um breve formulário de pré-qualificação antes da discovery call. Isso não só filtra leads menos qualificados, mas também permite personalizar a call, focando nas áreas de maior interesse do lead e demonstrando preparação.
...
5.  **Técnica do "Role Reversal" (Inversão de Papéis)**: Pedir ao lead para explicar a situação ou o problema para você, como se você não soubesse nada. Isso o faz verbalizar e solidificar a compreensão do problema, aumentando seu próprio senso de urgência e clareza sobre o desafio.
