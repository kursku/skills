...
description: "Multi Stakeholder Management — Skill especializada para multi stakeholder management"
license: MIT
metadata:
  version: 1.0.0
  author: Cafe Code AI
...
1.  **Inicie o mapeamento** dos stakeholders chave para o projeto de consultoria "Transformação Digital do RH" no Cliente "Inovação S.A.", identificando indivíduos e departamentos.
2.  **Preencha a Matriz de Poder/Interesse** para os stakeholders identificados, classificando o CFO, Diretor de RH, Gerente de TI e Líderes de Unidade de Negócio.
3.  **Elabore um plano de comunicação inicial** diferenciado para o patrocinador executivo (CFO) e para os gerentes de processo, focando em benefícios estratégicos para o primeiro e operacionais para o segundo.
4.  **Agende a primeira reunião de alinhamento** com o Comitê Diretor do projeto, apresentando a visão estratégica e coletando expectativas de cada membro.
...
1.  **Identificação Ampliada de Stakeholders (Fase 0 - Diagnóstico):**
...
2.  **Construção e Validação da Matriz Poder/Interesse (Fase 1 - Planejamento):**
...
3.  **Análise de Relações e Mapeamento de Influência (Fase 2 - Execução):**
...
4.  **Priorização e Definição de Estratégias de Engajamento (Fase 2 - Execução Contínua):**
...
1.  **Criação do Plano de Comunicação Multi-Nível (Fase 1 - Planejamento):**
...
2.  **Execução de Reuniões de Alinhamento Estratégico (Fase 2 - Execução):**
...
3.  **Gestão Proativa de Expectativas e Feedback Loop (Fase 2 - Execução Contínua):**
...
4.  **Reporting Personalizado e Health Score Multi-Stakeholder (Fase 3 - Monitoramento):**
...
**Objetivo da Reunião:** Alinhar a visão do projeto "Plataforma de Inovação Aberta", estabelecer expectativas e definir os próximos passos para todos os stakeholders envolvidos.

**Duração:** 90 minutos

---

**1. Abertura e Boas-Vindas (5 min)**
...
- [X] Matriz de Poder/Interesse de stakeholders preenchida e validada com o patrocinador do projeto?
- [X] Plano de comunicação segmentado por grupo de stakeholder (executivo, gerencial, operacional) definido?
- [X] Pautas de reuniões customizadas para cada nível hierárquico e seus interesses específicos?
- [X] Mecanismos de coleta de feedback (formais e informais) implementados para stakeholders de baixo poder?
- [X] Responsáveis (RACI) definidos e comunicados para as principais entregas e decisões do projeto?
- [X] Plano de Gestão de Riscos incluindo potenciais resistências de stakeholders mapeado e mitigado?
- [X] Relatórios de progresso personalizados para cada grupo de stakeholder, destacando métricas relevantes?
- [X] Health Score do Projeto com componente de engajamento de stakeholders implementado e monitorado?
- [X] Sessões de alinhamento e workshops de co-criação agendadas com stakeholders-chave para construir adesão?
- [X] Canais de comunicação de emergência e gestão de crises definidos para desalinhamentos críticos?
...
1.  **Focar Exclusivamente no Patrocinador Executivo**: Muitas vezes, consultores se concentram apenas no C-level que contratou o projeto, negligenciando gerentes intermediários e equipes operacionais.
...
2.  **Comunicar "Uma Mensagem Para Todos"**: Enviar o mesmo relatório de progresso ou a mesma mensagem para stakeholders com interesses e níveis de compreensão distintos.
...
3.  **Ignorar Resistências Ocultas e Agendas Pessoais**: Presumir que todos os stakeholders estão alinhados com os objetivos do projeto, sem investigar agendas individuais ou departamentais que podem gerar resistência.
